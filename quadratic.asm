...
;ubuntu@admin11:~/ML$ nasm -f elf64 quad.asm -o quad.o
;ubuntu@admin11:~/ML$ ld -o quad quad.o
;ubuntu@admin11:~/ML$ ./quad
;Root1: 800000000000000003.00Root2: 800000000000000005.
